        ...
        <div class="grid grid-cols-1 gap-16 mx-auto max-w-7xl md:grid-cols-2">
            ...
            <div class="p-8" data-aos="fade-right">
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        <button type="submit"
                            class="flex items-center justify-center w-full gap-2 px-4 py-2 font-medium text-orange-500 transition border border-orange-500 rounded-lg hover:bg-orange-100 focus:ring-2 focus:ring-orange-500">
                            Kirim Pesan
            ...
            <div class="flex flex-col items-start justify-center gap-6 text-center lg:text-left" data-aos="fade-left">
                ...
                <div class="flex flex-col gap-3 text-base text-black meta-info">
                    <div class="flex items-center justify-center gap-2 lg:justify-start">
                        <i class="text-lg text-orange-500 fas fa-phone"></i>
                        <span class="text-base">(+62) 851 2873 01213</span>
                    </div>
                    <div class="flex items-center justify-center gap-2 lg:justify-start">
                        <i class="text-lg text-orange-500 fas fa-envelope"></i>
