<div class="w-full mx-auto aspect-[16/9] relative">
    <div id="default-carousel" class="relative w-full h-full" data-carousel="slide">
        ...
        <div class="relative w-full aspect-[16/9] overflow-hidden">
            @foreach ($data['eventupcoming'] as $key => $item)
                <div class="hidden duration-1000 ease-out" data-carousel-item>
                    <a href="{{ route('detail', ['tag' => $item->tag->tag, 'slug' => $item->slug]) }}" class="relative">
                        <img src="{{ Storage::url($item->cover->first()->image_path) }}" class="block object-cover w-full h-full" alt="Image {{ $key+1 }}">
                        <div class="absolute top-0 left-0 w-full overflow-hidden aspect-[16/9] z-[90] flex flex-col items-center justify-end p-6 text-center text-white bg-opacity-50 bg-red">
